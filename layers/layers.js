...
var format_Pollinisateurssauvages_7 = new ol.format.GeoJSON();
var features_Pollinisateurssauvages_7 = format_Pollinisateurssauvages_7.readFeatures(json_Pollinisateurssauvages_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Pollinisateurssauvages_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Pollinisateurssauvages_7.addFeatures(features_Pollinisateurssauvages_7);
var lyr_Pollinisateurssauvages_7 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Pollinisateurssauvages_7, 
                style: style_Pollinisateurssauvages_7,
                interactive: true,
                title: '<img src="styles/legend/Pollinisateurssauvages_7.png" /> Pollinisateurs sauvages'
            });
...
lyr_OSMStandard_0.setVisible(true);lyr_REGION_1.setVisible(true);lyr_DIR_2.setVisible(true);lyr_Autre_3.setVisible(true);lyr_Fenaison_4.setVisible(true);lyr_Arbres_5.setVisible(true);lyr_Ecopturage_6.setVisible(true);lyr_Pollinisateurssauvages_7.setVisible(true);lyr_EEE_8.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_REGION_1,lyr_DIR_2,lyr_Autre_3,lyr_Fenaison_4,lyr_Arbres_5,lyr_Ecopturage_6,lyr_Pollinisateurssauvages_7,lyr_EEE_8];
...
lyr_Autre_3.set('fieldAliases', {'fid': 'fid', 'id': 'id', 'nom': 'nom', 'DISTRICT': 'DISTRICT', 'gestionnai': 'gestionnai', 'Année': 'Année', 'Commentair': 'Commentair', 'Catégorie': 'Catégorie', 'Pratique': 'Pratique', 'Route': 'Route', });
...
lyr_Arbres_5.set('fieldAliases', {'fid': 'fid', 'id': 'id', 'nom': 'nom', 'DISTRICT': 'DISTRICT', 'gestionnai': 'gestionnai', 'Année': 'Année', 'Commentair': 'Commentair', 'Catégorie': 'Catégorie', 'Pratique': 'Pratique', 'Route': 'Route', });
lyr_Ecopturage_6.set('fieldAliases', {'fid': 'fid', 'id': 'id', 'nom': 'nom', 'DISTRICT': 'DISTRICT', 'gestionnai': 'gestionnai', 'Année': 'Année', 'Commentair': 'Commentair', 'Catégorie': 'Catégorie', 'Pratique': 'Pratique', 'Route': 'Route', });
lyr_Pollinisateurssauvages_7.set('fieldAliases', {'id': 'id', 'nom': 'nom', 'DISTRICT': 'DISTRICT', 'gestionnai': 'gestionnai', 'Année': 'Année', 'Commentair': 'Commentair', 'Catégorie': 'Catégorie', 'Pratique': 'Pratique', 'Route': 'Route', });
lyr_EEE_8.set('fieldAliases', {'id': 'id', 'nom': 'nom', 'DISTRICT': 'DISTRICT', 'gestionnai': 'gestionnai', 'Année': 'Année', 'Commentair': 'Commentair', 'Catégorie': 'Catégorie', 'Pratique': 'Pratique', 'Route': 'Route', });
...
lyr_Autre_3.set('fieldImages', {'fid': 'TextEdit', 'id': 'TextEdit', 'nom': 'TextEdit', 'DISTRICT': 'TextEdit', 'gestionnai': 'TextEdit', 'Année': 'TextEdit', 'Commentair': 'TextEdit', 'Catégorie': 'TextEdit', 'Pratique': 'TextEdit', 'Route': 'TextEdit', });
...
lyr_Arbres_5.set('fieldImages', {'fid': 'TextEdit', 'id': 'TextEdit', 'nom': 'TextEdit', 'DISTRICT': 'TextEdit', 'gestionnai': 'TextEdit', 'Année': 'TextEdit', 'Commentair': 'TextEdit', 'Catégorie': 'TextEdit', 'Pratique': 'TextEdit', 'Route': 'TextEdit', });
lyr_Ecopturage_6.set('fieldImages', {'fid': 'TextEdit', 'id': 'TextEdit', 'nom': 'TextEdit', 'DISTRICT': 'TextEdit', 'gestionnai': 'TextEdit', 'Année': 'TextEdit', 'Commentair': 'TextEdit', 'Catégorie': 'TextEdit', 'Pratique': 'TextEdit', 'Route': 'TextEdit', });
lyr_Pollinisateurssauvages_7.set('fieldImages', {'id': 'TextEdit', 'nom': 'TextEdit', 'DISTRICT': 'TextEdit', 'gestionnai': 'TextEdit', 'Année': 'Range', 'Commentair': 'TextEdit', 'Catégorie': 'TextEdit', 'Pratique': 'TextEdit', 'Route': 'TextEdit', });
lyr_EEE_8.set('fieldImages', {'id': 'TextEdit', 'nom': 'TextEdit', 'DISTRICT': 'TextEdit', 'gestionnai': 'TextEdit', 'Année': 'Range', 'Commentair': 'TextEdit', 'Catégorie': 'TextEdit', 'Pratique': 'TextEdit', 'Route': 'TextEdit', });
...
lyr_Autre_3.set('fieldLabels', {'fid': 'no label', 'id': 'inline label', 'nom': 'inline label', 'DISTRICT': 'inline label', 'gestionnai': 'inline label', 'Année': 'inline label', 'Commentair': 'inline label', 'Catégorie': 'inline label', 'Pratique': 'inline label', 'Route': 'inline label', });
...
lyr_Arbres_5.set('fieldLabels', {'fid': 'no label', 'id': 'inline label', 'nom': 'inline label', 'DISTRICT': 'inline label', 'gestionnai': 'inline label', 'Année': 'inline label', 'Commentair': 'inline label', 'Catégorie': 'inline label', 'Pratique': 'inline label', 'Route': 'inline label', });
lyr_Ecopturage_6.set('fieldLabels', {'fid': 'no label', 'id': 'inline label', 'nom': 'inline label', 'DISTRICT': 'inline label', 'gestionnai': 'inline label', 'Année': 'inline label', 'Commentair': 'inline label', 'Catégorie': 'inline label', 'Pratique': 'inline label', 'Route': 'inline label', });
lyr_Pollinisateurssauvages_7.set('fieldLabels', {'id': 'no label', 'nom': 'inline label', 'DISTRICT': 'inline label', 'gestionnai': 'inline label', 'Année': 'inline label', 'Commentair': 'inline label', 'Catégorie': 'inline label', 'Pratique': 'inline label', 'Route': 'inline label', });
lyr_EEE_8.set('fieldLabels', {'id': 'no label', 'nom': 'inline label', 'DISTRICT': 'inline label', 'gestionnai': 'inline label', 'Année': 'inline label', 'Commentair': 'inline label', 'Catégorie': 'inline label', 'Pratique': 'inline label', 'Route': 'inline label', });
lyr_EEE_8.on('precompose', function(evt) {
